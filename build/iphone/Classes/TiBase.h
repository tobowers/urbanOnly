...
// in simulator we redefine to format for urbanOnly Developer console
...
{\
	NSString * exceptionName = [@"org.urbanonly." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.urbanonly";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIurbanOnlyNativeItemNone = -1, 
	UIurbanOnlyNativeItemSpinner = -2,
	UIurbanOnlyNativeItemProgressBar = -3,
	
	UIurbanOnlyNativeItemSlider = -4,
	UIurbanOnlyNativeItemSwitch = -5,
	UIurbanOnlyNativeItemMultiButton = -6,
	UIurbanOnlyNativeItemSegmented = -7,
	
	UIurbanOnlyNativeItemTextView = -8,
	UIurbanOnlyNativeItemTextField = -9,
	UIurbanOnlyNativeItemSearchBar = -10,
	
	UIurbanOnlyNativeItemPicker = -11,
	UIurbanOnlyNativeItemDatePicker = -12,
	
	UIurbanOnlyNativeItemInfoLight = -13,
	UIurbanOnlyNativeItemInfoDark = -14,
	
	UIurbanOnlyNativeItemDisclosure = -15,
	
	UIurbanOnlyNativeItemContactAdd = -16
};
